...
summary: The process of making a site for ranking southpark episodes.
...
Update my tier list, we check if one exists and if it doesnt we will create a new one.
