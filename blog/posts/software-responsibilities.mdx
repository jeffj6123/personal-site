...
I have been on the service fabric team for a couple years now, with a primary focus on improving supportability. Supportability can mean a lot of things so let's narrow it down to the scope of a platform for developers/administrators. While there are more groups who use this product, the examples ahead will be easier to identify what makes them more effective if using this lens. 

We will talk about the following expectations for a platform to user interaction

* A products ability to inform users when there is an issue 
* A products ability to differentiate when it's a "platform" issue or a "user*
* A products ability to thoroughly explain an issue and how to resolve it
