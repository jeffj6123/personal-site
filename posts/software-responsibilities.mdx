...
## Wrapping up
By using these layout tools and design choices, we have been able to take SFX and make it a much more powerful starting point for investigation. A lot of these improvements have driven reductions in incidents and faster time to mitigate for incidents.
